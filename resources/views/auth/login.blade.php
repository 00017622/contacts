...
<div class="form__actions">
    ...
    <button type="submit" class="form__button form__button--primary">Sign in</button>

    <a href="{{route('register')}}" class="form__signuplink">Dont have an account, register here</a>
</div>
